...
void loop() {
  ...
  static bool doublSensFlag;


  // ремап цветовой индикации
  charge_level_1 = map(charge_level, 788, 940, 0, 100);
  ch_lvl_G = map(charge_level_1, 30, 100, 0, 253);
  ch_lvl_G = constrain(ch_lvl_G, 0, 253);
  ch_lvl_R = map(charge_level_1, 0, 70, 255, 0);
  ch_lvl_R = constrain(ch_lvl_R, 0, 253);
  
//  Serial.print(charge_level);
//  Serial.print("   ");
//  Serial.print(charge_level_1);
//  Serial.print("   ");
//  Serial.print(ch_lvl_G);
//  Serial.print("   ");
//  Serial.println(ch_lvl_R);
//  delay(500);
